...
counter=0
actual_label=[]
data = genfromtxt('C:\Users\Shubham Chourasia\PycharmProjects\SOMBatchTest\SOMPY-master\data_set\iris.csv', delimiter=',',dtype=None,usecols=(4))
for i in range(len(data)):
    if data[i]== "Iris-setosa":
        actual_label.insert(i,0)
    elif data[i]== "Iris-versicolor":
        actual_label.insert(i,1)
    elif data[i]=="Iris-virginica":
        actual_label.insert(i,2)

Idata = genfromtxt('C:\Users\Shubham Chourasia\PycharmProjects\SOMBatchTest\SOMPY-master\data_set\iris.csv', delimiter=',',usecols=(0,1,2,3))
#print Idata
