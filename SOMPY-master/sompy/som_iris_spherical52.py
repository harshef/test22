...
Iflag=0 #Flag
x = []  #store all center
DunnIndex=[] #List of DI against each solution in population
sil_sco=[] #List of Silhoutte Score angainst each solution in population
counter=0
actual_label=[]
data = genfromtxt('/home/acer/PycharmProjects/SOMBatch_FIX/SOMPY-master/data_set/spherical_5_2.csv', delimiter=',',dtype=None,usecols=(2))

actual_label=data


Idata = genfromtxt('/home/acer/PycharmProjects/SOMBatch_FIX/SOMPY-master/data_set/spherical_5_2.csv', delimiter=',',usecols=(0,1))
print type(Idata)
print Idata
...
n = 5#int(input("Enter the no. of clusters to be formed:"))
Initial_Label=[]
