...
counter=0
actual_label=[]
data = genfromtxt('C:\Users\Shubham Chourasia\PycharmProjects\SOMBatchTest\SOMPY-master\data_set\glass.csv', delimiter=',',dtype=None,usecols=(10))
#print data
for i in range(len(data)):
    if data[i]== "WinF":
        ...
        actual_label.insert(i, 3)
    elif data[i] == "Tabl":
        actual_label.insert(i, 4)
    elif data[i] == "Head":
        actual_label.insert(i, 5)


print actual_label
Idata = genfromtxt('C:\Users\Shubham Chourasia\PycharmProjects\SOMBatchTest\SOMPY-master\data_set\glass.csv', delimiter=',',usecols=(1,2,3,4,5,6,7,8,9))
#print Idata
