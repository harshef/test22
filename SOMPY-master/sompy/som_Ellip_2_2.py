...
counter=0
actual_label=[]
data = genfromtxt('F:\IITP\PyCharm projects\UPDATE 16 Apr 2017\SOMBatchTest\SOMPY-master\data_set\Ellip_2_2.csv', delimiter='\t',dtype=None,usecols=(2))

actual_label=data

Idata = genfromtxt('F:\IITP\PyCharm projects\UPDATE 16 Apr 2017\SOMBatchTest\SOMPY-master\data_set\Ellip_2_2.csv', delimiter='\t',usecols=(0,1))
#print Idata
