...
counter=0
actual_label=[]
data = genfromtxt('C:\Users\Shubham Chourasia\PycharmProjects\SOMBatchTest\SOMPY-master\data_set\New_thyroid.csv', delimiter=',',dtype=None,usecols=(0))
for i in range(len(data)):
    actual_label.insert(i,data[i])
print actual_label
Idata = genfromtxt('C:\Users\Shubham Chourasia\PycharmProjects\SOMBatchTest\SOMPY-master\data_set\New_thyroid.csv', delimiter=',',usecols=(1,2,3,4,5))
print Idata
...
n = 3#int(input("Enter the no. of clusters to be formed:"))
Initial_Label=[]
