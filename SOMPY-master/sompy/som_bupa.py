...
counter=0
actual_label=[]
data = genfromtxt('F:\IITP\PyCharm projects\UPDATE 16 Apr 2017\SOMBatchTest\SOMPY-master\data_set\Bupa.csv', delimiter=',',dtype=None,usecols=(6))

actual_label=data


Idata = genfromtxt('F:\IITP\PyCharm projects\UPDATE 16 Apr 2017\SOMBatchTest\SOMPY-master\data_set\Bupa.csv', delimiter=',',usecols=(0,1,2,3,4,5))
print actual_label
print Idata
