...
counter=0
actual_label=[]
data = genfromtxt('F:\IITP\PyCharm projects\UPDATE 16 Apr 2017\SOMBatchTest\SOMPY-master\data_set\Spherical_9_2_wc.csv', delimiter='\t',dtype=None,usecols=(2))
for i in range(len(data)):
  actual_label=data

Idata = genfromtxt('F:\IITP\PyCharm projects\UPDATE 16 Apr 2017\SOMBatchTest\SOMPY-master\data_set\Spherical_9_2_wc.csv', delimiter='\t',usecols=(0,1))
#print Idata
...
n = 9#int(input("Enter the no. of clusters to be formed:"))
Initial_Label=[]
